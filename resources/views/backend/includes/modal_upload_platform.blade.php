<div class="modal fade" id="m_upload_platform" tabindex="-1" aria-labelledby="ModalUploadPlatform" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('backend.import_platform') }}" method="POST" enctype="multipart/form-data"
                id="form-upload-platform" class="needs-validation" novalidate>
                <div class="modal-header">
                    <h4 class="modal-title">Upload Report Platform</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                    </button>
                </div>
                <div class="modal-body">
                    <h6 class="mb-3">Pastikan Format Upload Sesuai <a class="link-danger"
                            href="{{ asset('template/template_report_platform.xlsx') }}">Template</a></h6>
