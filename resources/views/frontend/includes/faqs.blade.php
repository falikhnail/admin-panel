        ...
        <div class="row row-cols-1 gx-4 gx-lg-5 text-white">
            ...
            <div class="col mt-3">
                ...
                <div class="row row-cols-1 ms-2 mt-3">
                    ...
                    <div class="col mt-2">
                        <div class="d-flex flex-column">
                            <a href="#faq-8" class="d-flex none align-items-center" data-bs-toggle="collapse">
                                <i class="bi bi-caret-down-square"></i>
                                <span class="ms-2">
                                    Jika saya mengetahui seseorang memakai karya saya tanpa izin, apa yang saya dapat
                                    lakukan? </span>
                            </a>
                            <div id="faq-8" class="collapse mt-3">
                                <span>
                    ...
                    <div class="col mt-2">
                        <div class="d-flex flex-column">
                            <a href="#faq-9" class="d-flex none align-items-center" data-bs-toggle="collapse">
                                <i class="bi bi-caret-down-square"></i>
                                <span class="ms-2">
                                    Apa yang akan terjadi jika seseorang memakai karya saya? </span>
                            </a>
                            <div id="faq-9" class="collapse mt-3">
                                <span>
                    ...
                    <div class="col mt-2">
                        <div class="d-flex flex-column">
                            <a href="#faq-10" class="d-flex none align-items-center" data-bs-toggle="collapse">
                                <i class="bi bi-caret-down-square"></i>
                                <span class="ms-2">
                                    Apa syarat sebuah karya dapat didaftarkan? </span>
                            </a>
                            <div id="faq-10" class="collapse mt-3">
                                <span>
                    ...
                    <div class="col mt-2">
                        <div class="d-flex flex-column">
                            <a href="#faq-11" class="d-flex none align-items-center" data-bs-toggle="collapse">
                                <i class="bi bi-caret-down-square"></i>
                                <span class="ms-2">
                                    Apakah ada laporan royalti mengenai yang saya dapatkan? </span>
                            </a>
                            <div id="faq-11" class="collapse mt-3">
                                <span>
